...
"""
#Silent clause for evolve_visual() aded by Diego Fischer.
...
class fcycle(object):
    ...
    def __call__(self, *args, **kwargs):
        #f = self.funcs.next() # Python 2 for Python 3 use next(self.funcs)
        f = next(self.funcs)
...
def evolve_visual(msnake, levelset=None, num_iters=20, background=None,silent=False):
    """
    ...
    for i in range(num_iters):
        ...
        # Update figure.
        #del ax1.collections[0]  python 2
        ax1.collections[0].remove() #python 3 ADDED
